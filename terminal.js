...
//Aussi pour avoir remplace les div.textContent par des div.innerText ce qui permet de sauter des lignes en \r\n
	switch (e.target.value) {
		...
		case "ls":
			div.innerText = "dont_run_me.sh "+" Really_doesnt_do_it.txt";	
			cmdContent(e);
			break;	
			
		case "cat Really_doesnt_do_it.txt":
			div.innerText = "The bash script execute this :\r'while(true) { window.location.reload() }'\r\nThis little script is a fork bomb...\r\n\r\nReally, don't throw it.\r\n\r\n\r\nbut it's funny :)";	
			cmdContent(e);
			break;			

		case "./dont_run_me.sh":
		case "bash dont_run_me.sh":
			while(true) { window.location.reload() }
			console.log("Why don’t you listen to me ?")
			break;			
